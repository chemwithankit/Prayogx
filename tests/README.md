...
Seven suites that check the things the library check cannot: that the **single-source
...
| `../tools/production_audit.py` | python3 | 36 single-source checks: IDs, revisions, hashes, feed agreement, no duplicated content, cache keying, deploy hygiene |
